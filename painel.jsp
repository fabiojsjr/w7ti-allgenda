		...
		<div class="maincontent">
			<div class="maincontentinner">
				...
				<div class="row-fluid">
					...
					<script>
						javascript:calendario(1, 0, <%=request.getParameter("id")%>);
					</script>
					...
					<!-- RODAPE -->
				  	...
				  	<div class="footer">
						<div class="footer-left">
							<p>&copy; <%= new SimpleDateFormat("yyyy").format(new Date()) %>. <%=p.get("TODOS_DIREITOS_RESERVADOS") %> &reg; - <a style="color : black;" href="http://www.atallsolutions.com.br">www.wwwwwwwww.com.br</a> </p>
					  	</div>
					</div><!--footer-->
