...
public abstract class IntranetBaseCommand extends AbstractCommand {
	...
	public static final String LOGIN_TAG = "intranetLoginAllgenda";
	...
	public static UsuarioEntity getLoggedUser(UserSession session, CommandWrapper wrapper) throws ExceptionWarning {
		try {
			...
			if (entity==null) {
				if (wrapper!=null && !wrapper.getNextPage().contains(PAGE_ALERT_AJAX_CLEAN)) {
					wrapper.setNextPage(PAGE_INTRA_LOGIN);
				}
