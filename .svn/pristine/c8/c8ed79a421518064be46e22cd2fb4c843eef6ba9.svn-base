			...
			<%
				...
				if( fileFound ) {
					...
					if(isZip){
						...
						<%
						// Ao contrério de mostrar a img de um avatar, mostrar uma img galleryZip, para demonstrar que possui mais de uma imagem
						path = "";
						ff   = "/allgenda/images/galleryZip.png";
// 						Code abaixo apaga o zip da pasta média
