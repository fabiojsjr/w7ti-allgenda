...
<div class="clear20"></div>
	<div>	
		...
		<%	if( !usuarioLogado.semPermissaoAcesso(idFunc, "incluir") ) { %>
			<div class="inline">
				<button class="btn btn-primary btn-circle grouped_elements" href="salaReuniaoEdit.jsp" style="width: 200px"><span class="iconfa-plus-sign icon-white"></span> <%= p.get("ADICIONAR") %> Sala de reunião</button>
			</div>
		<%	} %>
	...
	<table class="table table-bordered" id="admin">
		...
		<thead>
			<tr>								
				...
				<th class="head1 nosortable">NÚMERO</th>
				<th class="head0 nosortable">AÇÕES</th>
			</tr>
		</thead>
		<tbody>
		</tbody>
