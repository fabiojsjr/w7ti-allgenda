 ...
 *
 *	Copyright (c) 2012 ThemePixels (../http/MS_7.html)
 *	
...
jQuery(document).ready(function(){
	...
	jQuery("#form1").validate({
		...
		messages: {
			firstname: "Entre com seu Nome",
			lastname: "Entre com login",
			email: "Entre com email vÃ¡lido",
			location: "LocalizaÃ§Ã£o errada",
