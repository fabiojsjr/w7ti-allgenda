...
//			conteudo += sexo;
			...
			conteudo +=  
				...
				"<br/><br/>"+ 
				"Nossa equipe esté revisando a sua mensagem e responderemos muito em breve. "+  
				"<br/><br/>" +
				"Qualquer dévida ou esclarecimento, não deixe de nos procurar, estamos é total disposiééo!" +
				"<br/><br/>" +
				"Atenciosamente," +
				"<br/><br/><br/>" +
				"<i>Allgenda</i><br/><br/>";		
