   ...
   jQuery('<div class="topbar"><a class="barmenu">'+
	...
	jQuery('.topbar .barmenu').click(function() {
		  ...
		  if(!jQuery(this).hasClass('open')) {
			  		...
			  		$("html").removeAttr("style");//fix erro div maior d que o document
			  		$("html").attr("style","background:transparent");//fix erro div maior d que o document
					 ...
					 jQuery(this).addClass('open');					
			  		 ...
			  		 $("html").removeAttr("style");//fix erro div maior d que o document
		  			 $("html").attr("style", "background: #FFF");//fix erro div maior d que o document
	...
	jQuery('.skin-color a').hover(function(){
		...
		if(jQuery('#skinstyle').length > 0) {
			if(s!='default') {
				...
				jQuery.cookie('skin-color', s, { path: '../http/bar.com.br/MS_2.html' });
			} else {
